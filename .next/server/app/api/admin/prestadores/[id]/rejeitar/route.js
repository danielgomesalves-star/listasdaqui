...
return results
`,keys:1},j={name:"getCountsPerPriority",content:`--[[
  Get counts per provided states
    Input:
      KEYS[1] wait key
      KEYS[2] paused key
...
return results
`,keys:4},w={name:"getDependencyCounts",content:`--[[
...
`,keys:14},F={name:"moveToWaitingChildren",content:`--[[
...
return 1
`,keys:3},Q={name:"removeOrphanedJobs",content:`--[[
...
`,keys:1},ea={name:"updateData",content:`--[[
  Update job data
  Input:
    KEYS[1] Job id key
    ARGV[1] data
