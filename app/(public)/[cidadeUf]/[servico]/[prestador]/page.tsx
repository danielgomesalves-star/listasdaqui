            ...
            <div className="flex flex-col flex-1 pb-16 bg-white overflow-y-auto">
                ...
                <div className="relative px-5 py-6 bg-gradient-to-br from-[#0F172A] to-[#0E4D7A]">
                    ...
                    <div className="flex gap-2">
                        <a
                            href={`https://api.whatsapp.com/send/?phone=55${prestador.telefone || prestador.whatsapp}&text=${encodeURIComponent(`Olá! Vi seu perfil no *ListasDaqui* para ${servico.nome} e gostaria de entrar em contato.`)}&type=phone_number&app_absent=0`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 flex items-center justify-center gap-2 bg-wa text-white p-[13px] rounded-sm text-sm font-bold no-underline font-sans cursor-pointer transition-opacity hover:opacity-90"
                        >
